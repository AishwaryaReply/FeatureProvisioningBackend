...
export namespace Stubs {
    ...
    //updateFeature
    export const mockInputUpdateFeature: DataModels.UpdatedFeature={
        description: "XXX",
        channels: [{ code: "XXX", description: "XXX" }, 
                   { code: "YYY", description: "YYY" }]
    };

    export const mockInputUpdateFeatureNull: DataModels.UpdatedFeature={
        description: null,
        channels: [{ code: null, description: null }, 
                   { code: null, description: null }]
    };

    export const mockInputUpdateFeatureSpecialCharNumerics: DataModels.UpdatedFeature={
        description: "3546@$%",
        channels: [{ code: "3546@$%", description: "3546@$%" }, 
                   { code: "3546@$%", description: "3546@$%"}]
    };

    export const mockInputUpdateFeatureLowercase: DataModels.UpdatedFeature={
        description: "XXX",
        channels: [{ code: "XXX", description: "XXX" }, 
                   { code: "YYY", description: "YYY" }]
    };
    ...
    //deleteFeature     //NOT COMPLETED
    export const mockInputDeleteFeature: {
        code: "XXX"
    };
    ...
    export const mockOutputDeleteFeature: DataModels.DeleteResponse={
      ...
      //getListFeatures     //NOT COMPLETED
      export const mockInputGetListFeatures: {
        code: "XXX",
        description: "XXX",
        channel: "XXX"
    };
